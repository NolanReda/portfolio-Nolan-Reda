      ...
      <div className='top-box d-flex'>
        <div className='mt-5 text-center hello-nolan'>
          ...
          <div className='about-me'>
            <p className='font-s text-center text-monospace'>
            ...
            <button className='download btn btn-lg mt-4 btn-outline-primary'>
        ...
        <div className='personal-photo d-flex justify-content-center align-items-center mt-5'>
          {/* <img className='myself' src="img/graduate-photo-hero.jpg" alt="Nolan Reda" /> */}
        </div>
      </div>
